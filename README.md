...
## Aenderungsprotokoll
- `1.6.8` (2026-02-15): Sprachwechsel in den Einstellungen hinzugefuegt (`language-select`), direkt mit der vorhandenen i18n-Logik verbunden; Manifest-Cache-Buster auf `v=1608`.
